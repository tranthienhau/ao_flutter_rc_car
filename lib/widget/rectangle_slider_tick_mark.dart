...
class RectangleSliderTickMarkShape extends SliderTickMarkShape {
  /// Create a slider tick mark that draws a circle.
  const RectangleSliderTickMarkShape({
    this.tickMarkRadius,
  });
  ...
  Size getPreferredSize({
    ...
    return Size.fromRadius(tickMarkRadius ?? sliderTheme.trackHeight!);
  }
